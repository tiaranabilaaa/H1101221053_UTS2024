              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="email" value="tiaranabila@gmail.com">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="Jl. Jawa">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
          ...
          <div class="card card-profile">
            ...
            <div class="card-body pt-0">
              ...
              <div class="text-center mt-4">
                <h5>
                  Tiara Nabila<span class="font-weight-light">, 20</span>
                </h5>
